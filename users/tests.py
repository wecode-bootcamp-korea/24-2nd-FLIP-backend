...
from users.models   import Bank, BankAccount, User
...
class BankAccountViewTestPOST(TestCase):
    ...
    def test_user_error(self):
        ...
        response = client.post("/users/bank_account/3",json.dumps(user_bank_account), content_type="application/json")
        self.assertEqual(response.json(), {"ERROR" : "USER_DOES_NOT_EXIST"} )
        self.assertEqual(response.status_code, 404)
    ...
    def test_account_number_error(self):
        ...
        response = client.post("/users/bank_account/1",json.dumps(user_bank_account), content_type="application/json")
    ...
    def test_user_bank_account_update_post_success(self):
        ...
        response = client.post("/users/bank_account/2",json.dumps(user_bank_account), content_type="application/json")
